diff --git a/../../sims/GRAPE-simulation/src/.DS_Store b/../../sims/GRAPE-simulation/src/.DS_Store
deleted file mode 100644
index 5008ddf..0000000
Binary files a/../../sims/GRAPE-simulation/src/.DS_Store and /dev/null differ
diff --git a/../../sims/GRAPE-simulation/src/ActionInitialization.cc b/GRAPE-CE/src/ActionInitialization.cc
old mode 100644
new mode 100755
index 6bb9647..b3f7c97
--- a/../../sims/GRAPE-simulation/src/ActionInitialization.cc
...
diff --git a/../../sims/GRAPE-simulation/src/DetectorConstruction.cc b/GRAPE-CE/src/DetectorConstruction.cc
old mode 100644
new mode 100755
index d84a74b..19bea7b
--- a/../../sims/GRAPE-simulation/src/DetectorConstruction.cc
...
@@ -115,157 +143,155 @@ namespace grape
...
@@ -1077,11 +803,11 @@ namespace grape
...
+        else if ( (row == 0) || (row == kNumScint_X-1) ) { // Calorimeter
           new G4PVPlacement(
                   0,                    // its rotation
                   detColumn_Pos,        // its position
@@ -1218,10 +962,10 @@ namespace grape
...
+                  mPEEK,                // its material
     ...
     // Physical Volume
@@ -1290,17 +1034,15 @@ namespace grape
                   0,                    // copy number
                   fCheckOverlaps);      // checking overlaps 
...
+                  mPEEK,                // its material
     ...
     // Physical Volume
@@ -1358,16 +1100,15 @@ namespace grape
                   0,                    // copy number
                   fCheckOverlaps);      // checking overlaps 
...
+                  mPEEK,                // its material
     ...
     // Physical Volume
@@ -1425,283 +1166,18 @@ namespace grape
                   0,                    // copy number
                   fCheckOverlaps);      // checking overlaps 
...
@@ -1766,15 +1242,15 @@ namespace grape
                   0,                    // copy number
                   fCheckOverlaps);      // checking overlaps 
...
+                  fCheckOverlaps);      // checking overlaps 
     ...
     //----------------------------------
     // Detector Element
@@ -1801,11 +1277,10 @@ namespace grape
                   mVacuum,               // its material
...
@@ -1871,132 +1346,52 @@ namespace grape
       }
     }
...
+    }
     ...
     //----------------------------------
     // Scintillator
@@ -2050,107 +1445,105 @@ namespace grape
                   0,                    // copy number
                   fCheckOverlaps);      // checking overlaps 
...
+                  fCheckOverlaps);      // checking overlaps 
     ...
     //----------------------------------
     // Optical Pad
@@ -2158,19 +1551,19 @@ namespace grape
     // Solid Volume
...
@@ -2198,16 +1591,15 @@ namespace grape
                   0,                    // copy number
                   fCheckOverlaps);      // checking overlaps 
...
+                  fCheckOverlaps);      // checking overlaps 
     ...
     //----------------------------------
     // SiPM
@@ -2215,19 +1607,19 @@ namespace grape
     // Solid Volume
...
@@ -2255,15 +1647,15 @@ namespace grape
                   0,                    // copy number
                   fCheckOverlaps);      // checking overlaps 
...
+                  fCheckOverlaps);      // checking overlaps 
     ...
     //----------------------------------
@@ -2275,16 +1667,16 @@ namespace grape
...
@@ -2316,56 +1708,47 @@ namespace grape
                   0,                    // copy number
                   fCheckOverlaps);      // checking overlaps 
...
@@ -2375,21 +1758,22 @@ namespace grape
...
@@ -2401,23 +1785,15 @@ namespace grape
...
+    // calHouse_LV -> SetVisAttributes( G4VisAttributes::GetInvisible() );
     ...
     //======================================================
     // Step Limits
@@ -2426,227 +1802,12 @@ namespace grape
...
@@ -2668,8 +1829,32 @@ namespace grape
...
+    G4cout << G4endl;
     ...
     //======================================================
@@ -2697,109 +1882,5 @@ namespace grape
...
-  }
 ...
 //%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
diff --git a/../../sims/GRAPE-simulation/src/DetectorMessenger.cc b/GRAPE-CE/src/DetectorMessenger.cc
old mode 100644
new mode 100755
index dc90bab..e4113c8
--- a/../../sims/GRAPE-simulation/src/DetectorMessenger.cc
...
diff --git a/../../sims/GRAPE-simulation/src/EventAction.cc b/GRAPE-CE/src/EventAction.cc
old mode 100644
new mode 100755
index 0bb98f8..4c002f3
--- a/../../sims/GRAPE-simulation/src/EventAction.cc
...
diff --git a/../../sims/GRAPE-simulation/src/PhysicsList.cc b/GRAPE-CE/src/PhysicsList.cc
old mode 100644
new mode 100755
index 1b904d2..74e9645
--- a/../../sims/GRAPE-simulation/src/PhysicsList.cc
...
diff --git a/../../sims/GRAPE-simulation/src/PhysicsListMessenger.cc b/GRAPE-CE/src/PhysicsListMessenger.cc
old mode 100644
new mode 100755
index 70955ed..7996d38
--- a/../../sims/GRAPE-simulation/src/PhysicsListMessenger.cc
...
diff --git a/../../sims/GRAPE-simulation/src/PrimaryGeneratorAction.cc b/GRAPE-CE/src/PrimaryGeneratorAction.cc
old mode 100644
new mode 100755
index bc4239b..5a48e2b
--- a/../../sims/GRAPE-simulation/src/PrimaryGeneratorAction.cc
...
diff --git a/../../sims/GRAPE-simulation/src/RunAction.cc b/GRAPE-CE/src/RunAction.cc
old mode 100644
new mode 100755
index 3df6ddd..9eda393
--- a/../../sims/GRAPE-simulation/src/RunAction.cc
...
diff --git a/../../sims/GRAPE-simulation/src/ScintHit.cc b/GRAPE-CE/src/ScintHit.cc
old mode 100644
new mode 100755
index a831ce7..0f40c61
--- a/../../sims/GRAPE-simulation/src/ScintHit.cc
...
+//%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 ...
 //
 /// \file ScintHit.cc
diff --git a/../../sims/GRAPE-simulation/src/ScintSD.cc b/GRAPE-CE/src/ScintSD.cc
old mode 100644
new mode 100755
index e853bb9..dda6537
--- a/../../sims/GRAPE-simulation/src/ScintSD.cc
